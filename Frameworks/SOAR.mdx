...
---
<img height="200" src="/images/SOAR.png" />

SOAR is a primitive that provides a seamless solution for creating leaderboards and achievements and managing player's proof of play on the Solana blockchain. With support for invocation from a TypeScript client and the upcoming integration with the Solana.Unity-SDK, SOAR aims to simplify the process of managing and tracking achievements in decentralized applications.
