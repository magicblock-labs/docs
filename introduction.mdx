...
### Where do I start?
You can start building the logic of your game with our [BOLT framework](https://docs.magicblock.gg/BOLT/Introduction/introduction). 
If you are looking for scalability/low-latency, check out our the [Ephemeral Rollups](https://docs.magicblock.gg/EphemeralRollups/ephemeral_rollups) section instead.
