...
MagicBlock is a Solana network extension for building a new type of consumer applications that are **open**, **decentralized** and **unstoppable**. MagicBlock accelerates and extends Solana's capabilities while preserving composability.
