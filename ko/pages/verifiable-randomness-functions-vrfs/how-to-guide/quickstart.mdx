---
title: "빠른 시작"
description: "MagicBlock VRF SDK로 Solana VRF 온체인 랜덤니스를 요청하고 소비하는 방법을 알아봅니다."
---
...
<Note>
  로컬 머신에서 VRF를 엔드투엔드로 실행하고 싶나요? 전체 로컬 스택, Surfpool 대안, 로컬 <code>vrf-oracle</code> 흐름은 <a href="/ko/pages/ephemeral-rollups-ers/how-to-guide/local-development">Local Development</a> 가이드를 참고하세요.
</Note>
