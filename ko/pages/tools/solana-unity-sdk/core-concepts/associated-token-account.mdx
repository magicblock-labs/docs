...
description: "Associated Token Account Program은 사용자의 지갑 주소를 해당 사용자가 보유한 관련 토큰 계정에 매핑하는 규칙과 메커니즘을 정의합니다."
---

Associated Token Account에 대한 전체 개요는 Solana 공식 [문서](https://spl.solana.com/associated-token-account)를 참고하세요.
