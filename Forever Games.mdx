...
Forever Games or fully on-chain games refer to those games whose state and logic run entirely on a blockchain. Along the [spectrum](https://jumpcrypto.com/writing/defining-on-chain-gaming/) of blockchain integrations, this is the most extreme case where literally your whole game is on-chain.

There are several reasons why building your game fully on-chain can be advantageous.
