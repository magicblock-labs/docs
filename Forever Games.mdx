...
**Crypto-primitives** - onchain games are natively plugged in a rich system of protocols and dapps that developers can permissionlessly access to enrich the player's experience or to enhance distribution. Defi for in-game economies, identity primitives, market-driven governance systems (e.g. [Futarchy](https://docs.themetadao.org/) and global payments are only a few examples of what can be leveraged out of the box, since everything is accessible and composable.
