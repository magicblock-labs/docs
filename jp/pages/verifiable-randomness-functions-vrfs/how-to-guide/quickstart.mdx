---
title: "クイックスタート"
description: "MagicBlock VRF SDK を使って Solana VRF のオンチェーンランダムネスを要求し利用する方法を学びます。"
---
...
<Note>
  手元のマシンで VRF をエンドツーエンド実行したいですか？完全ローカルスタック、Surfpool の代替、ローカル <code>vrf-oracle</code> フローについては <a href="/jp/pages/ephemeral-rollups-ers/how-to-guide/local-development">Local Development</a> ガイドを使ってください。
</Note>
