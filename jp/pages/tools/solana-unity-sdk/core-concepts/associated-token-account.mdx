...
description: "Associated Token Account Program は、ユーザーのウォレットアドレスを保有する関連トークンアカウントへ対応付けるための規約と仕組みを定義します。"
---

Associated Token Account の全体像については、Solana 公式[ドキュメント](https://spl.solana.com/associated-token-account)を参照してください。
