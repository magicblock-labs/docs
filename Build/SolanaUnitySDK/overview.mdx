...
<CardGroup cols={2}>
  <Card
    title="Installation"
    icon="location-arrow"
    href="/SolanaUnitySDK/getting-started/installation"
    iconType="duotone"
  >
  ...
  <Card
    ...
    icon="wallet"
    href="/SolanaUnitySDK/getting-started/configuration"
    iconType="duotone"
  >
  ...
  <Card
    title="Core Concepts"
    icon="hexagon-check"
    href="/SolanaUnitySDK/core-concepts/associated-token-account"
    iconType="duotone"
  >
  ...
  <Card
    title="Guides"
    icon="books"
    href="/SolanaUnitySDK/guides/mint-an-nft"
    iconType="duotone"
  >
