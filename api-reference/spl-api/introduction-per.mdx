...
- [**Initialize Global Vault ATA**](/api-reference/spl-api/initialize-global-vault-ata) - Create a global vault ATA

### Token Operations

- [**Initialize Ephemeral ATA**](/api-reference/spl-api/initialize-ephemeral-ata) - Create a new ephemeral token account
