---
title: "质押"
description: "SOL 代币持有者可以将代币质押给一个或多个验证器，以赚取奖励并帮助保护网络。质押奖励取决于当前通胀率、网络中的总质押 SOL 数量，以及单个验证器的在线率和佣金（费用）。"
---

你可以在 Solana 官方[文档](https://spl.solana.com/stake-pool/overview#staking)中了解 Staking。
