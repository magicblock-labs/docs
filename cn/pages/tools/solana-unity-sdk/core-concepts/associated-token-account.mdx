---
title: "关联代币账户"
description: "Associated Token Account Program 定义了约定，并提供了将用户钱包地址映射到其持有关联代币账户的机制。"
---

有关 Associated Token Account 的完整概览，请参阅 Solana 官方[文档](https://spl.solana.com/associated-token-account)。
