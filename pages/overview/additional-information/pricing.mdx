...
| **Fee type**                                   | **Amount (SOL)** | **Description**        |
| :--------------------------------------------- | :--------------- | :--------------------- |
| **Base fee (within 1–2 slots)**                | 0.00009          | Per randomness request |
| **Priority fee (guaranteed within 1–2 slots)** | 0.00015          | Per randomness request |

[Learn more about VRF →](/pages/verifiable-randomness-functions-vrfs)
