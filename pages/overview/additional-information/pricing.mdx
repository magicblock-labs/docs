...
**Public nodes** make it simple to start building with no default ER transaction fee. When an account is undelegated, MagicBlock takes the session and commit charges from the deposit funded during delegation. Longer sessions can also use a delegated fee payer.
...
<table style={{ width: "100%", tableLayout: "fixed" }}>
  ...
  <tbody>
    <tr>
      <td>Base fee</td>
      <td>0</td>
      <td>Per ER transaction by default; a validator can change this price</td>
    </tr>
    <tr>
      <td>Session fee</td>
      <td>0.0003</td>
