...
[Learn more about ER →](/pages/ephemeral-rollups-ers/introduction/why)
...
[Learn more about VRF →](/pages/verifiable-randomness-functions-vrfs/introduction/why-verifiable-randomness-onchain)
