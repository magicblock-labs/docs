---
title: "FAQ"
description: "Common questions about Solana VRF"
---

Solana VRF answers the most common implementation questions before you ship on-chain randomness.
...
The VRF operates within the [ephemeral rollup](/pages/get-started/introduction/ephemeral-rollup) execution window, so results are typically available within a single transaction round, without external polling.
