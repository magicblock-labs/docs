...
Access control in Private Ephemeral Rollups enables fine-grained permission over permissioned accounts. Each permission account maintains a list of members with specific flags that determine what actions they can perform.
