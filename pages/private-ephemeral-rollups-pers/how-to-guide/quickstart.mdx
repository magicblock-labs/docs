...
<Tabs>
    ...
    <Tab title="2. Restrict">
        Create and update account-level permissions with members through permission program `ACLseoPoyC3cBqoUtkbjZ4aDrkurZW86v19pXz2XQnp1`:
        <RestrictCode />
        [⬆️ Back to Top](#code-snippets)
    </Tab>
        ...
        This is the list of ER validator:
        <Validators />
        <DelegateCode />
