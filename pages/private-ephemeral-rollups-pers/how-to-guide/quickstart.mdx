...
<Tabs>
    ...
    <Tab title="2. Delegate and create permission">
        ...
        - `delegate` delegates only the counter to the TEE validator (no base-layer permission CPI).
        ...
        - `undelegate` commits and undelegates the counter via `MagicIntentBundleBuilder` — no separate permission undelegation step.
