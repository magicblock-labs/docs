...
## Design for leverage safely

“1000x” changes the risk model, not the navigation path. Before increasing leverage, define:

- oracle freshness, confidence, and failure behavior;
- maintenance margin and liquidation thresholds;
- maximum position, market exposure, and utilization;
