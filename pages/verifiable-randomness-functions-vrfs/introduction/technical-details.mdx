...
<Note>
  MagicBlock's VRF Program is open-source and audited. See the <a href="/pages/overview/additional-information/solana-vrf">Solana VRF overview</a> for the product summary.
</Note>
