...
description: "Move SPL tokens at Ephemeral Rollup speed — the ephemeral token account model, the global vault, delegation, and how private payments build on top."
---
...
**Ephemeral SPL Tokens** let you hold and move SPL tokens inside a MagicBlock Ephemeral Rollup (ER)
