...
funds and move them at Ephemeral Rollup speed. The core pattern: a program-owned account, delegated to
...
<Steps>
  <Step title={<a href="#1-er-aware">Make your program ER-aware</a>}>
  ...
  <Step title={<a href="#3-delegate">Delegate the eATA</a>}>
    CPI into the Ephemeral SPL Token program to delegate it to the ER.
  </Step>
  <Step title={<a href="#4-transfer">Move tokens PDA-signed</a>}>
    Sign the transfer as the custody PDA inside the rollup.
  </Step>
  <Step title={<a href="#5-commit">Commit & undelegate</a>}>
...
<Tabs>
  ...
  <Tab title="4. PDA-signed transfer">
