...
- ✅ **Program Cloning** – No fragementation. Programs live on the base layer and can interact with any existing protocol and assets.
...
<img height="200" src="/images/magicblock-er.png" />
...
<CardGroup cols={2}>
  ...
  <Card
    title="Build"
    icon="hammer"
    href="/pages/get-started/how-integrate-your-program/introduction"
    iconType="duotone"
  >
