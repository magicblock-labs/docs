...
Public nodes let anyone start building with no default ER transaction fee. When an account is undelegated, MagicBlock takes the session charge and commit charges from the deposit funded during delegation. Longer sessions can also use a delegated fee payer.
