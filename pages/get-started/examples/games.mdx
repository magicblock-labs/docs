...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals"
    iconType="duotone"
  >
...
- **The Backend**, this is the source code for the smart contract of the game
  ...
  - Source code is available: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/tree/main/backend)
...
- **The Frontend**, this is the User Interface of the game
  ...
  - Source code is available: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/tree/main/frontend)
...
When the user opens the "Create" page, we run create a new game: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/blob/main/frontend/src/states/gameCreate.ts)
...
When the user opens the main page, we fetch the list of existing games from the chain: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/blob/main/frontend/src/states/gameList.ts)

1. When the user joined the game's page, we start listening to the game's state inside the ephemeral: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/blob/main/frontend/src/states/gameListen.ts)
2. We update the UI to display the map every time the game changes inside of the ephemeral, you can find the code for the page logic: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/blob/main/frontend/src/components/page/PagePlay.tsx)
3. When the user executes a move on the map, we send the command transaction through directly in the ephemeral: [HERE](https://github.com/magicblock-labs/magicblock-engine-examples/tree/main/solana-generals/blob/main/frontend/src/states/gameSystemCommand.ts)
