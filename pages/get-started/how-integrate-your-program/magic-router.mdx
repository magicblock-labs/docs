...
<Tip> Try out a demo of the Magic Router [here](https://router-demo.magicblock.app/) or explore our Pyth price data demo [here](https://pyth-template.magicblock.app/)</Tip>
