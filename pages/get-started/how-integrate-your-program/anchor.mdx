...
<CardGroup cols={2}>
  <Card
    ...
    icon="anchor"
    href="https://github.com/magicblock-labs/magicblock-engine-examples/blob/a7744840c848f353add7936ed0f124bcda0ad53c/anchor-counter/programs/anchor-counter/src/lib.rs#L12"
    iconType="duotone"
  ></Card>
  <Card
