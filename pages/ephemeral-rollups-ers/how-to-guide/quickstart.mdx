...
import DelegateOnCurveWeb3jsCode from "/snippets/delegate-oncurve-web3js-instructions.mdx";
import DelegateOnCurveKitCode from "/snippets/delegate-oncurve-kit-instructions.mdx";
...
<Tabs>
  ...
  <Tab title="Delegate On-Curve">
    Two instructions are required to delegate an on-curve account:
      1. Assign System Account to Delegation Program
      2. Delegate to Delegation Program
  
    <Warning>Currently, on-curve accounts cannot be undelegated.</Warning>
    <CodeGroup>
      <DelegateOnCurveKitCode />
      <DelegateOnCurveWeb3jsCode />
    </CodeGroup>
